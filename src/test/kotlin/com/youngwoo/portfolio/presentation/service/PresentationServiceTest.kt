package com.youngwoo.portfolio.presentation.service

import com.youngwoo.portfolio.domain.entity.Introduction
import com.youngwoo.portfolio.domain.entity.Link
import com.youngwoo.portfolio.presentation.repository.PresentationRepository
...
class PresentationServiceTest {
    ...
    fun testGetIntroductions(){
        ...
        val activeIntroductions = introductions.filter {
            introduction -> introduction.isActive // 필터링
        }
